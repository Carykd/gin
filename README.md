...
[![Build Status](https://github.com/Carykd/gin/workflows/Run%20Tests/badge.svg?branch=master)](https://github.com/Carykd/gin/actions?query=branch%3Amaster)
[![codecov](https://codecov.io/gh/gin-gonic/gin/branch/master/graph/badge.svg)](https://codecov.io/gh/gin-gonic/gin)
[![Go Report Card](https://goreportcard.com/badge/github.com/Carykd/gin)](https://goreportcard.com/report/github.com/Carykd/gin)
[![Go Reference](https://pkg.go.dev/badge/github.com/Carykd/gin?status.svg)](https://pkg.go.dev/github.com/Carykd/gin?tab=doc)
[![Sourcegraph](https://sourcegraph.com/github.com/Carykd/gin/-/badge.svg)](https://sourcegraph.com/github.com/Carykd/gin?badge)
[![Open Source Helpers](https://www.codetriage.com/gin-gonic/gin/badges/users.svg)](https://www.codetriage.com/gin-gonic/gin)
[![Release](https://img.shields.io/github/release/gin-gonic/gin.svg?style=flat-square)](https://github.com/Carykd/gin/releases)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/Carykd/gin)](https://www.tickgit.com/browse?repo=github.com/Carykd/gin)
...
```sh
import "github.com/Carykd/gin"
```

Alternatively, use `go get`:

```sh
go get -u github.com/Carykd/gin
```
...
A number of ready-to-run examples demonstrating various use cases of Gin are available in the [Gin examples](https://github.com/Carykd/examples) repository.

## Documentation

See the [API documentation on go.dev](https://pkg.go.dev/github.com/Carykd/gin).
...
Here are some awesome projects that are using the [Gin](https://github.com/Carykd/gin) web framework.
