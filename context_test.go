...
import (
	...
	testdata "github.com/Carykd/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/Carykd/gin.handlerNameTest$", c.HandlerName())
}
...
func TestContextInitQueryCache(t *testing.T) {
	validURL, err := url.Parse("https://github.com/Carykd/gin/pull/3969?key=value&otherkey=othervalue")
	require.NoError(t, err)
